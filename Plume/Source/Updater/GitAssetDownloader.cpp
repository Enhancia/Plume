                                                                       ...
                                                                       URL::DownloadTask::Listener* listenerPtr)
{
    ...
    if (getRedirectURL (assetURL, serverURL))
    {
        ...
        return serverURL.downloadToFile (fileToDownloadTo, URL::DownloadTaskOptions().withListener (listenerPtr));
    }
...
bool GitAssetDownloader::getRedirectURL (const URL& assetURL, URL& redirectURL)
{
    ...
    std::unique_ptr<InputStream> gitAssetStream (assetURL.createInputStream (URL::InputStreamOptions (URL::ParameterHandling::inAddress)
